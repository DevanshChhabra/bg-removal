...
const BgSlider = () => {
  ...
  return (
    <div className='pb-10 md:py-20 mx-2'>
        {/* Title  */}
        <h1 className='mb-12 sm:mb-20 text-center text-2xl md:text-3xl lg:text-4xl mt-4 py-2 font-semibold gradient-heading'>Remove Background With <br /> High Quality and Accuracy</h1>
